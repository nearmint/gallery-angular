...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-gallery></app-gallery>\n<br/>\n<app-category></app-category>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _image_collection_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _gallery_gallery_component__WEBPACK_IMPORTED_MODULE_6__["GalleryComponent"], _category_category_component__WEBPACK_IMPORTED_MODULE_7__["CategoryComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatGridListModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatChipsModule"]],
  ...
  /***/
  function srcAppBildTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Bild", function () {
      return Bild;
    });
    /* harmony import */
  ...
  function srcAppCategoryCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _image_collection_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../image-collection.service */
    "./src/app/image-collection.service.ts");

    var CategoryComponent = /*#__PURE__*/function () {
      function CategoryComponent(imageCollection) {
      ...
      _createClass(CategoryComponent, [{
        ...
        key: "editCategory",
        value: function editCategory(event, category) {
          event.path[1].style.display = 'none';
          document.getElementById("".concat(category, "2")).style.display = 'inline';
        }
      }, {
        key: "saveCategory",
        value: function saveCategory(event, category, i) {
          event.path[1].style.display = 'none';
          document.getElementById("".concat(category, "1")).style.display = 'inline';
          this.categories[i] = document.getElementById("".concat(category, "2-2")).value;
          localStorage.setItem("categories", JSON.stringify(this.categories));
        }
      }, {
        key: "deleteCategory",
        value: function deleteCategory(i) {
  ...
  function srcAppGalleryGalleryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _bild__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../bild */
    "./src/app/bild.ts");
    /* harmony import */


    var _image_collection_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../image-collection.service */
    "./src/app/image-collection.service.ts");

    var GalleryComponent = /*#__PURE__*/function () {
      function GalleryComponent(imageCollection) {
        ...
        this.bild = new _bild__WEBPACK_IMPORTED_MODULE_2__["Bild"](); // for (let i = 0; i < this.images.length; i+=6) {
      ...
      _createClass(GalleryComponent, [{
        key: "addCategoryToImage",
        value: function addCategoryToImage(index) {
        ...
        value: function filterCategories(cat) {
          ...
          this.showImages = this.images.filter(function (image) {
            return image.category.includes(cat);
          });
        }
      }, {
        key: "resetFilter",
        ...
        key: "formShowFunction",
        value: function formShowFunction() {
          if (this.formShow) {
            return "inline";
          }
        ...
        value: function addImage() {
          ...
          for (var e = 0; e < this.addCategory.length; e++) {
          ...
          this.images.push(this.bild);
          console.log(this.bild); //this.emptyString = null;

          this.bild = new _bild__WEBPACK_IMPORTED_MODULE_2__["Bild"]();
          this.formShow = !this.formShow;
          this.newImages = []; // for (let i = 0; i < this.images.length; i+=6) {
          //   let repeat = Math.floor(this.images.length/6);
          //   console.log(repeat);
          //   if (i/6 === repeat) {
          //     let str = "this.newImages.push([";
  ...
  /***/
  function srcAppImageCollectionServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ImageCollection", function () {
    ...
    var _bild__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./bild */
    "./src/app/bild.ts");
      ...
      _createClass(ImageCollection, [{
        ...
        value: function loadImages() {
          ...
          if (localStorage.getItem("photos")) {
            ...
            photos = photos.map(function (element) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/florian/Documents/workspace/bildergalerie-angular-julian/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
